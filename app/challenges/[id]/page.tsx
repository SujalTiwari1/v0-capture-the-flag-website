      ...
      <div className="p-6">
        ...
        <div className="bg-slate-900 border border-slate-700 rounded p-4 mb-4">
          <p className="text-slate-300 mb-3">
            The organization has hidden internal services. Start by exploring
            this endpoint:
          </p>
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded p-4">
          <p className="text-sm text-yellow-300">
            <span className="font-semibold">Tip:</span> Each page you discover
            may contain clues about where to look next. Keep exploring and
            follow the hints!
          </p>
        </div>
      </div>
